...
/**
 * A demo class for running the phone book manager.
 *
...
public class PhoneBookDemo {
    ...
    /**
     * A default constructor. Creates a main.PhoneBook object.
     */
    public PhoneBookDemo(){
         ...
         */
        System.out.print("Select (h)ashing, (t)ree or (l)ist: ");
        String input = inputScanner.nextLine().toLowerCase();
        while ( ! ( ( input.startsWith("h") ) || ( input.startsWith("t") )
                || ( input.startsWith("l") ) ) ){
            System.out.print("Invalid input. Please answer h/t/l. ");
